...
# Project:  mouse.pro
# Template: app
# Command: C:\Qt\5.9.1\mingw53_32\bin\qmake.exe -o Makefile mouse.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
#############################################################################
...
Makefile: mouse.pro ../../../../Qt/5.9.1/mingw53_32/mkspecs/win32-g++/qmake.conf ../../../../Qt/5.9.1/mingw53_32/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -o Makefile mouse.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
